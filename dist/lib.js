(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['crashme'] = factory();
  else root['crashme'] = factory();
})(this, () => {
  return /******/ (() => {
    // webpackBootstrap
    /******/ 'use strict';
  ...
  \*****************************************/
        /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          function initCrashDetection(options) {
            ...
            // main entry point
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getDb)(options.dbName).then(function (result) {
              return (db = result);
            });
          ...
          function initClientWorker(options) {
            ...
            setInterval(function () {
              ...
              if (lastInfo === null || lastInfo === void 0 ? void 0 : lastInfo.id) {
                ...
                store.put(
                  __assign(__assign({}, structuredClone(lastInfo)), {
                    tabLastActive: tabLastActive,
                    workerLastActive: workerLastActive,
                  })
                );
              }
                  ...
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      port_1.addEventListener('close', function () {
                        openPorts = openPorts.filter(function (p) {
                          return p !== port_1;
                        });
                      });
                      port_1.start();
  ...
  \*****************************/
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ initClientWorker: () =>
          /* reexport safe */ _client_worker__WEBPACK_IMPORTED_MODULE_1__.initClientWorker,
        /* harmony export */ initCrashDetection: () =>
          /* reexport safe */ _client_controller__WEBPACK_IMPORTED_MODULE_0__.initCrashDetection,
        /* harmony export */ initDetectorWorker: () =>
          /* reexport safe */ _detector_worker__WEBPACK_IMPORTED_MODULE_2__.initDetectorWorker,
        /* harmony export */
      });
      /* harmony import */ var _client_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ./client-controller */ './public/lib/client-controller.ts'
      );
      /* harmony import */ var _client_worker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! ./client-worker */ './public/lib/client-worker.ts'
      );
      /* harmony import */ var _detector_worker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        /*! ./detector-worker */ './public/lib/detector-worker.ts'
      );
    })();
